...
ticker = "APPL"  # símbolo del título bursátil en website: https://finance.yahoo.com/
# nombre del título bursátil
nombre_ticker = "Apple_histórico"
data_start = "2022-01-01"  # fecha de inicio de la serie
data_end = "2023-01-01"    # fecha de cierre de la serie
